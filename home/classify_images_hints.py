...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       # as classifier label
       model_label = ""
#MSB --> model_label = classifier(images_dir + key, model) ; return from the classifier : imagenet_classes_dict[pred_idx]
       ...
       truth = results_dic[key][0]   # Image label from results_dic for the key
       # where key = results_dic[key][0] --> 'Boston_terrier_02250.jpg'
       ## truth = 'boston terrier' for the key 'Boston_terrier_02250.jpg'
